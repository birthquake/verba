...
prompt: `This is an emergency department encounter. Prioritize clarity and urgency in all translations.  Use triage vocabulary, vital signs terminology, and trauma language where appropriate.  Translate time-sensitive instructions with directness and precision.`,
},
{
label: ‘Maternity’,  code: ‘maternity’,
prompt: `This is a maternity or obstetrics encounter. Use terminology appropriate for labor, delivery,  prenatal care, postpartum recovery, and infant care. Be precise with contraction timing,  dilation measurements, and fetal monitoring terms.`,
},
{
label: ‘Pediatrics’, code: ‘pediatrics’,
prompt: `This is a pediatric encounter. When speaking to the patient use age-appropriate language.  When speaking to the parent or caregiver use clear, non-alarming clinical language.  Use developmental and growth terminology where appropriate.`,
},
{
label: ‘Cardiology’, code: ‘cardiology’,
prompt: `This is a cardiology encounter. Use precise cardiac terminology including symptoms,  diagnostic procedures, medications, and monitoring terms. Be exact with measurements  such as blood pressure readings, heart rate, and ejection fraction values.`,
},
{
label: ‘Surgery’,    code: ‘surgery’,
prompt: `This is a surgical encounter. Use terminology appropriate for pre-operative consent,  post-operative instructions, wound care, pain management, and anesthesia.  Be precise with procedure names and recovery expectations.`,
},
];
...
- Return only the translated text, nothing else`; if (selectedSpecialty.prompt) return `${base}\n\nSpecialty context:\n${selectedSpecialty.prompt}`;
  return base;
  };
...
Write in clear, clinical language. Be brief — this is a quick reference, not a full note. Do not include patient names or identifying information. Return only the summary, no preamble.`, }, { role: 'user', content: `Specialty: ${selectedSpecialty.label}\nLanguages: English — ${selectedLang.label}\n\nTranscript:\n${transcriptLines}` },
],
}),
});
const data = await res.json();
