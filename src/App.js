  ...
  return (
    <div className="app">
      ...
      {showPatientIntroPrompt && (
        <div className="intro-prompt-overlay" onClick={() => setShowPatientIntroPrompt(false)}>
          <div className="intro-prompt-box" onClick={(e) => e.stopPropagation()}>
            <div className="panic-icon">👋</div>
            ...
            <button className="intro-prompt-btn-primary" onClick={() => { setShowPatientIntroPrompt(false); setShowOnboarding(true); }}>Show Introduction</button>
            <button className="intro-prompt-btn-secondary" onClick={() => setShowPatientIntroPrompt(false)}>Skip</button>
          </div>
        </div>
      )}
